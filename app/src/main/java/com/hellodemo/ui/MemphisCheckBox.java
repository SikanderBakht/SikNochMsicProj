...
public class MemphisCheckBox extends AppCompatCheckBox {
    ...
    public MemphisCheckBox(Context context) {
        super(context);
        applyCustomFont(context);
    }

    public MemphisCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public MemphisCheckBox(Context context, AttributeSet attrs, int defStyle) {
