...
public class NavOpenGroupsAdapter extends RecyclerView.Adapter<NavOpenGroupsAdapter.NavGroupViewHolder> {

    AppCompatActivity mActivity;
    private int selectedItemPosition = -1;
    private NavMenuModel data;

    public NavOpenGroupsAdapter(AppCompatActivity appCompatActivity) {
    ...
    public int getItemCount() {
        if (data == null || data.getOpenGroups() == null) return 0;
        return data.getOpenGroups().size();
    }
    ...
    public void setSelectedGroup(NavGroupItem group) {
        if (group == null)
            ...
            selectedItemPosition = data.getOpenGroups().indexOf(group);
        notifyDataSetChanged();
    }
    ...
    public class NavGroupViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBindView(int position) {
            if (data == null && data.getOpenGroups() == null) return;
            ...
            Log.d("Test","Correct");
            NavGroupItem group = data.getOpenGroups().get(position);
