...
public class PlaceAutocompleteAdapter
    ...
    private static final String TAG = "PAutocompleteAdapter";
    ...
    public PlaceAutocompleteAdapter(Context context, GeoDataClient geoDataClient,
        ...
        super(context, R.layout.location_list_item, R.id.text1);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String address = item.getPrimaryText(STYLE_BOLD) + ", " + item.getSecondaryText(STYLE_NORMAL);
